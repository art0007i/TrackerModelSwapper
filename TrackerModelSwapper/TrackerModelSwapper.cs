...
{
    public class TrackerModelSwapper : ResoniteMod
    {
        ...
        public static ModConfigurationKey<string> KEY_TRACKER_MODEL = new("tracker_model", "The URL pointing towards your tracker model.", () => "resdb:///a421748d183ed60f8ea767b85ff7d0c7351b3a611ab04887aac4b5f2a0a500d3.7zbson", false, (s) => Uri.TryCreate(s, UriKind.Absolute, out var _));

        public static FieldInfo vive_model = AccessTools.Field(typeof(OfficialAssets.DeviceModels.SteamVR), "__uri_vr_tracker_vive_1_0");
